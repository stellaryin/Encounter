...
//		this.imageNameList = imageNameList;
		...
		for (int i = 0; i < imageCount; i++) {
			...
			if (i == 0) {
				mImageViews[i].setBackgroundResource(R.mipmap.icon_circle_h);
			} else {
				mImageViews[i].setBackgroundResource(R.mipmap.icon_circle_w);
			}
...
//				startImageTimerTask();
		...
		public void onPageSelected(int index) {
			...
			mImageIndex = index;
			// 设置图片滚动指示器背
			mImageViews[index].setBackgroundResource(R.mipmap.icon_circle_h);
